...
$(function () {
  ...
  if (typeof Chart !== 'undefined') {
    ...
    if ($("#donutChart").length) {
      ...
      // donut chart data
      var data = {
        labels: ["open", "close", "cancel"],
        datasets: [{
          data: [0, 0, 0],
          backgroundColor: [ "#ffcc29","#4ecc48", "#f37070"],
          hoverBackgroundColor: [ "#ffcc29", "#4ecc48","#f37070"],
          borderWidth: 0
        }]
      };
//      console.log(JSON.parse(document.getElementById('data_search').textContent));
//      var data_=document.getElementById('data_search').textContent.replace(/[/g,'').replace(/]/g,'');
//      var arr_data=data_.split(",");
//      console.log(arr_data);
      data.datasets[0].data=JSON.parse(document.getElementById('data_search').textContent);
    ...
    if ($("#donutChart1").length) {
      ...
      data.datasets[0].data=JSON.parse(document.getElementById('data_leave').textContent);
